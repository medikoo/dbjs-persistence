	...
	return function (t, a, d) {
		...
		return deferred(
			driver.indexKeyPath('computed', db.SomeType.instances)(function () {
				return deferred(driver.getComputedValue('fooBar', 'computed')(function (data) {
			...
			driver.indexKeyPath('computedSet', db.SomeType.instances)(function () {
				return deferred(driver.getComputedValue('fooBar', 'computedSet')(function (data) {
					a.deep(resolveEventKeys(data.value), ['elo', 'fooelo'], "Computed set: initial #1");
				}), driver.getComputedValue('aaa', 'computedSet')(function (data) {
			...
			driver.indexCollection('barByCol', db.SomeType.find('bar', 'elo'))(function () {
				return deferred(driver.getComputedValue('aaa', 'barByCol')(function (data) {
					a(data, null);
				}), driver.getComputedValue('bar', 'barByCol')(function (data) {
					a(data.value, '11');
